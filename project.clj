(defproject luminus-image-tagging "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot luminus-image-tagging.core
  ...
  {:nrepl {:port 7002}
   ...
   {:app
    {:target :browser
     ...
     :asset-path "/js"
     :modules {:app {:entries [luminus-image-tagging.app]}}
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "luminus-image-tagging.jar"
